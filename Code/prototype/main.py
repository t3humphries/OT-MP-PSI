...
# print(x)
# x = ShareGen_2(context=c, id=3, X=2, t=3, key=4, key_mac=5, randoms=[1, 2], randoms_mac=[3, 4], alpha=None)
# print(x)
...
for i in range(10):
    ...
    print(randoms_mac)
    x = ShareGen_2(
        context=c, id=rand_id, X=7, t=t, key=4, key_mac=5,
        randoms=randoms, randoms_mac=randoms_mac
    )
    ...
    x = ShareGen_2(
        context=c, id=rand_id, X=7, t=t, key=4, key_mac=5,
        randoms=randoms, randoms_mac=randoms_mac, alpha=None
    )
    print(x)
