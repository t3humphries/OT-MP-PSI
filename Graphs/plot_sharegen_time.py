...
plt.ylabel("Time in Milliseconds")
plt.grid()
plt.errorbar(dc_result_s2["t"], dc_result_s2["avg"], label="Same Datacenter", yerr=dc_result_s2["std"], marker="x", markersize=4)
plt.errorbar(ct_result_s2["t"], ct_result_s2["avg"], label="Across Continent", yerr=ct_result_s2["std"], marker="x", markersize=4)
plt.errorbar(ac_result_s2["t"], ac_result_s2["avg"], label="Across Atlantic", yerr=ac_result_s2["std"], marker="x", markersize=4)
plt.ylim(bottom=0)
plt.legend()
plt.savefig("TotalTimeS2.png")
plt.show()
...
plt.ylabel("Communication in MB")
plt.grid()
plt.errorbar(dc_result_s2["t"], dc_result_s2["comm"]/1000, label="Same Datacenter", marker="x", markersize=4)
plt.errorbar(ct_result_s2["t"], ct_result_s2["comm"]/1000, label="Across Continent", marker="x", markersize=4)
plt.errorbar(ac_result_s2["t"], ac_result_s2["comm"]/1000, label="Across Atlantic", marker="x", markersize=4)
plt.ylim(bottom=0)
plt.legend()
plt.savefig("TotalCommS2.png")
plt.show()
