...
scheme}\bmargin{*}{usually written with the threshold first ime.} meets the conditions that any size $t$ subset of the shares is sufficient to \emph{reconstruct
...
for primes $p'$ and $q'$. Letting $\mu=\text{lcm}(p-1,q-1)$\bmargin{*}{should define lcm although I'm assuming it is just least common multiple. Perhaps uppercase.},
